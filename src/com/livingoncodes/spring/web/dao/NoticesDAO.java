...
public class NoticesDAO {
	...
	public int[] batchUpdate(List<Notice> notices) {

		SqlParameterSource[] params = SqlParameterSourceUtils.createBatch(notices.toArray());

		return jdbc.batchUpdate("update  notices set name=:name, email=:email, text=:text where id=:id", params);
	}
